const id = "PT_EVENT_ACTOR_UNPIN_FROM_SCREEN";
const groups = ["Plugin Pak", "EVENT_GROUP_ACTOR"];
const name = "Unpin Actor from Screen";
...
const fields = [].concat([
  ...
  {
    label:
      "⚠️ If the actor is not pinned when this event is called its new position will be offset by the current scroll.",
  },
]);
...
VM_ACTOR_SET_FLAGS ${actorRef}, 0, ^/(.ACTOR_FLAG_PINNED)/;
  `);
